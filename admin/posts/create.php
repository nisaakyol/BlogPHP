    ...
    <div class="content">
      ...
      <form action="create.php" method="post" enctype="multipart/form-data">
        ...
        <div>
          ...
          <?php else: ?>
            <label><input type="checkbox" name="AdminPublish" <?php echo !empty($published) ? 'checked' : ''; ?>> Zum Publishen an Admin senden</label>
          <?php endif; ?>
        </div>

        <div><button type="submit" name="add-post" class="btn btn-big">Add Post</button></div>
      </form>
    </div>
  </div>
</div>
